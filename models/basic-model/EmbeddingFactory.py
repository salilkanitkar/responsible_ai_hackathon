...
class EmbeddingFactory:
    ...
    def __init__(self, embed_folder: Path, embedding_name: str, embed_dim: int, embed_zip_folder: str = None, **read_csv_kwargs):
        ...
        self.embed_folder, self.embedding_name = embed_folder, embedding_name
    ...
    def _parse_embeddings(self, embed_dir: Path, embed_dim: int, **read_csv_kwargs):
        ...
        reader = pd.read_csv(embed_zip.open(embed_file_in_zip), iterator=True, chunksize=30000, names=["word_vec"], sep="SOME_RANDOMS_STR", engine="python",
...
if __name__ == '__main__':
    embedding_index = EmbeddingFactory(Path("./embeddings/"), "GloVe.6B.100d", 100, "embeddings/glove-wiki", nrows=100, skiprows=None)
